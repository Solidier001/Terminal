...
<div class="head_box">
  <div id="head_wrap">
    <div id="head_nav">
      ...
      <span>|</span>
      <a class="head_nav_a" id="LodeMessage">联系客服</a>
        <script>
            $("#LodeMessage").attr("href","messadelode.action?id=${sessionScope.id}")
        </script>
      </c:if>
    </div>
    <div id="head_right">
  ...
  <div id="head_hot_goods_content">
    <ul>
      ...
      <li>
        ...
        <a class="floor_goods_price">309元</a>
      </li>
      <li>
        <a><img src="img/T1BsbjBvLT1RXrhCrK.jpg"></a>
        <a>大米活塞耳机</a>
        <a>2015红点奖，独家音质优化专利</a>
        <a class="floor_goods_price">200元</a>
      </li>
    </ul>
  </div>
</div>
