...
$(".floor_goods_wrap").children("ul").children("li").click(
    function () {
        var price=$(this).children(".floor_goods_price").text();
         price=price.replace("元","")
        var img=$(this).find("img").attr("src");
        var goodname=$(this).children(".floor_goods_tit").text();
        var describe=$(this).children(".floor_goods_txt").text();
        location=encodeURI("goods.jsp?src="+img+"&&price="+price+"&&goodname="+goodname+"&&describe="+describe);
    }
)
